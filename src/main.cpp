...
ez::Drive chassis(
   ...
   {-2, -11, -12},     // Left Chassis Ports (negative port will reverse it!)
...
void initialize() {
 ...
 ez::as::auton_selector.autons_add({
     ...
     {"2 goals LEFT auton \nbot facing left mark", left_auton_2},
     {"2 goals RIGHT auton \nbot facing right from black mark", right_auton_2},
     {"7 block long \nLEFT match auton \nbot 12 inches from back", left_auton_4},
     {"7 block long \nRIGHT match auton \nbot 12 inches from back", right_auton_4},
     {"left match auton", left_auton_1},
     {"right match auton", right_auton_1},
     //add other ones here-written by stella
});
...
void opcontrol() {
 ...
 while (true) {
   ...
   if (master.get_digital(DIGITAL_L1) || master.get_digital(DIGITAL_R1) || master.get_digital(DIGITAL_R2)) {
     conveyor.move(127);
   }
   ...
   descore.button_toggle(master.get_digital(DIGITAL_X));
